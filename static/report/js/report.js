  ...
  client.init(function loaded() {
    ...
    function show(event) {
      var options = {
        ...
        // Hanwiz - add starttime, endtime for select
        , starttime: 0
        , endtime: 0
      ...
      // Add startday,starttime and endday, endtime
    ...
    function loadData(day, options, callback) {
      ...
      } else if ((options.openAps || options.predicted || options.iob || options.cob) && datastorage[day] && !datastorage[day].devicestatus.length) {
      ...
      from = parseInt(from);
      console.log("FROM: ", starting, from, " ZONE: ", zone);
      ...
      to = parseInt(to);
      console.log("FROM: ", starting, from, " TO: ", nextday, to);
      ...
      function loadDevicestatusData() {
        ...
        if (true || options.iob || options.cob || options.openAps || options.predicted) {
