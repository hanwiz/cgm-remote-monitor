...
function configure (app, wares, ctx) {
  ...
  var express = require('express'),
    ...
    function ifModifiedSinceCTX (req, res, next) {
      ...
      //console.log("iFModifiedSinceTX : ", lastEntryDate, " ", ifModifiedSince);
      //modified by hanwiz to check lastEntryDate not null
      if (!ifModifiedSince || !lastEntryDate) { return next(); }
